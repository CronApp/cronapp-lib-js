    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      var setupOptions = {
        ...
        setup: function(ed) {
          ...
          if (ngAttrs.ngGetContent) { ed.on('GetContent', function () { clearTimeout(getContentTimeout); getContentTimeout = setTimeout(function() { scope.$eval(ngAttrs.ngGetContent); }, 100); }); }
      ...
      forceContentAndWatch = (instance, value) => {
